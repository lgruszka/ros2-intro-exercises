...
KOLEJNOŚĆ (3 terminale na robocie / laptopie, ten sam ROS_DOMAIN_ID):
    ...
    2) na ROBOCIE:  ros2 launch rplidar_ros rplidar_s3_launch.py serial_port:=/dev/ttyUSB1 frame_id:=rplidar_link   # → /scan
    3) na LAPTOPIE: ros2 launch rosbot_nav slam.launch.py          # TEN launch (use_sim_time:=false domyślnie)
